        ...
        <div class="card card-box">
            <div class="card-body">
                <div id="toolbar" class="btn-group">
                    <a href="{{ route('trajet.index') }}"  class="btn btn-outline-primary">
        ...
        function actionsFormatter(value, row, index) {
            return `
                    <div class="btn-group" trajet="group">
                        <a href="{{ route('trajet.index','')}}/${value}" class="btn btn-outline-primary waves-effect" data-toggle="tooltip" title="Modifier">
