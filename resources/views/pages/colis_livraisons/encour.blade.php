        ...
        function actionsFormatter(value, row, index) {
            return `
                    <div class="btn-group" quartier="group">
                        <a href="{{ route('demande_change_etat','')}}/${value}?etat=traite" class="btn btn-outline-success waves-effect" data-toggle="tooltip" title="Traiter">
                            Traiter
                        </a>
                        <a href="{{ route('demande_change_etat','')}}/${value}?etat=rejete" class="btn btn-outline-danger waves-effect" data-toggle="tooltip" title="Rejeter">
                            Rejeter
                        </a>
                    </div>`;
        }
